...
images:
  - "/images/projects/steeledtowngirlonasaturdaynight.jpg"
team:
...
## Overview
On June 28th, 2025, I posted instructions on creating your own AI agent using Microsoft Copilot. The downside to using Copilot is the parameter limitations it has built-in, being locked down to a walled garden, and the inherent risk of sharing sensitive data. This is fine if you're experimenting with it for fun, but not if people's data are at stake. The benefit to using a system such as Copilot however is the agentic nature that Microsoft is building with it, these technologies could bring organizations and enterprises into the "future" in the next 5 years if computation becomes cheap (more AI, more power used, you know the rest).
...
macOS users can download Ollama [here.](https://ollama.com/download/mac) (links to a download from Ollama's website)
