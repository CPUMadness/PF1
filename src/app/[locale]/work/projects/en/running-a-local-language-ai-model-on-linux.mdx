...
## Overview
On June 28th, 2025, I posted instructions on creating your own AI agent on Microsoft's servers using Microsoft Copilot. The downside to using Copilot is the limitations it has built-in, being locked down to Microsoft's domains, and the inherent risk of sharing sensitive data. This is fine if you're experimenting with it for fun, but not if people's data are at stake.
